...
rows = [
    ...
    ("• Corporate Tax: 0% on taxable income up to AED 375,000, 9% above. Small Business Relief (elect if revenue ≤ AED 3,000,000) gives 0% for tax periods ending on or before 31 Dec 2029 — extended from 2026 by Ministerial Decision 131 of 2026 (issued 29 July 2026).", False),
...
settings = [
    ...
    (7, "Standard VAT rate", 0.05, PCT, "UAE standard rate. Source: Federal Decree-Law No. 8 of 2017, tax.gov.ae; checked 2026-09-17.", True),
    (8, "VAT mandatory registration threshold", 375000, AED0, "Taxable supplies in past 12 months (or expected in the next 30 days) - a rolling test, not a year-end one. Unchanged for 2026; checked 2026-09-17.", False),
    (9, "VAT voluntary registration threshold", 187500, AED0, "Optional registration is available from this level of supplies or taxable expenses. Unchanged for 2026; checked 2026-09-17.", False),
    (10, "Corporate Tax rate", 0.09, PCT, "Source: Federal Decree-Law No. 47 of 2022; checked 2026-09-17.", True),
    (11, "Corporate Tax 0% band (taxable income)", 375000, AED0, "Taxable income up to this amount is taxed at 0%. Source: Federal Decree-Law No. 47 of 2022; checked 2026-09-17.", False),
    (12, "Elect Small Business Relief? (Yes/No)", "Yes", None, "Available if revenue ≤ threshold below, for tax periods ending on or before 31 Dec 2029 (extended by Ministerial Decision 131 of 2026). Election is made in the CT return, every period — it is not automatic.", True),
    (13, "Small Business Relief revenue threshold", 3000000, AED0, "Revenue, not profit - the test is turnover. Source: Ministerial Decision 73 of 2023; checked 2026-09-17.", False),
    (14, "Small Business Relief last eligible period end", dt.date(2029, 12, 31), DATE, "Relief not available for periods ending after this date. Extended from 31 Dec 2026 to 31 Dec 2029 by Ministerial Decision 131 of 2026; checked 2026-09-10.", False),
